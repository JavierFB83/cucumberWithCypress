Feature: Uso de intercept, buenas prácticas
  ...
  Scenario: Uso de wait
    ...
    Then I click on the button named "Aceptar todo" with a timeout of 500 miliseconds
  ...
  Scenario: Uso de intercept y wait al alias de la api call en pasos parametrizados
    ...
    And I wait maximum of 2000 miliseconds for the api call with the alias "cookies"
